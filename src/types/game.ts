...
export interface MenuSkill {
  ...
  activatedAt: Date;
  expiresAt: Date;
  type: 'coin_vacuum' | 'treasurer' | 'xp_surge' | 'luck_gem' | 'enchanter' | 'time_warp' | 'golden_touch' | 'knowledge_boost' | 'durability_master' | 'relic_finder' | 'stat_amplifier' | 'question_master' | 'gem_magnet' | 'streak_guardian' | 'revival_blessing' | 'zone_skipper' | 'item_duplicator' | 'research_accelerator' | 'garden_booster' | 'market_refresh' | 'mega_multiplier' | 'instant_heal' | 'perfect_accuracy' | 'treasure_magnet' | 'skill_cooldown' | 'auto_upgrade' | 'legendary_luck' | 'time_freeze' | 'double_rewards' | 'infinite_energy';
  isExpired?: boolean;
}
